...
export declare class OrdersController {
    ...
    updateStatus(id: string, userId: string, dto: UpdateOrderStatusDto): Promise<(import("../../schemas/order.schema").Order & import("mongoose").Document<import("mongoose").Types.ObjectId, any, any, Record<string, any>, {}> & Required<{
        _id: import("mongoose").Types.ObjectId;
    }> & {
        __v: number;
    }) | null>;
